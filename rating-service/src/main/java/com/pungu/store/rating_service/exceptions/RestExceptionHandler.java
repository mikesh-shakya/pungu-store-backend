...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleBookNotFound(ReviewNotFoundException ex,
    ...
    public ResponseEntity<ApiError> handleBookNotFound(DuplicateReviewException ex,
                                                       HttpServletRequest request) {
