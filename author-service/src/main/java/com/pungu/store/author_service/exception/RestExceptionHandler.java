...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleBookNotFound(AuthorNotFoundException ex,
                                                       HttpServletRequest request) {

        log.error("Author not found error for request {}", request.getRequestURI(), ex);
    ...
    public ResponseEntity<ApiError> handleBookNotFound(DuplicateAuthorException ex,
                                                       HttpServletRequest request) {

        log.error("Author already exists error for request {}", request.getRequestURI(), ex);
